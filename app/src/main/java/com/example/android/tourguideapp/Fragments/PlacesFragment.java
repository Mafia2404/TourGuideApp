...
public class PlacesFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        placedata.add(new Data("Aga Khan Palace",R.drawable.palce_agakhan));
        placedata.add(new Data("Lohagad Fort",R.drawable.place_lohagad));
        placedata.add(new Data("Dagdu Shet Temple",R.drawable.place_dagdusheth));
        placedata.add(new Data("Pawna Lake",R.drawable.place_paw));
        placedata.add(new Data("Shaniwar Wada",R.drawable.palce_shaniwar));
    }
}
